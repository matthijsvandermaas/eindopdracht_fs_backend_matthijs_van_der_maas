...
private final static String SECRET_KEY = "Lusiana";
...
private static String createToken(Map<String, Object> claims, String
        subject) {
        ...
        public Boolean validateToken(String token, String userDetails) {
                ...
                return username.equals(userDetails.intern()) && !isTokenExpired(token);
        }
