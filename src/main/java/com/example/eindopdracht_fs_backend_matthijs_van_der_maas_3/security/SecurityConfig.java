...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/productie_informatie").permitAll()
                .antMatchers("/inschrijfformulier").permitAll()
                .antMatchers("/inschrijfformulier_particulier").permitAll()
                .antMatchers("/inschrijfformulier_producent").permitAll()
