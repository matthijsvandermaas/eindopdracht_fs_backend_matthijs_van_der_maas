...
public class ProducentController {
    ...
    public ProducentController(ProducentRepository producentRepository, ProducentService producentService, ProducentService productService, SpringSecurityConfig passwordEncoder, ParticulierService particulierService, ProducentService particulierService1, ProducentService producentService1, ProducentRepository producentRepository1, AuthorityRepository rolesRepository, PasswordEncoder encoder, PasswordEncoder encoder1) {
