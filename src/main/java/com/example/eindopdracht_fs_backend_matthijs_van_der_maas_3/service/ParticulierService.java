...
public class ParticulierService {
    ...
    public Particulier createParticulier(ParticulierDto particulierDto) {
        try {
            Particulier particulier = new Particulier(roles, particulierDto.first_Name, particulierDto.last_Name, particulierDto.email, particulierDto.user_Name, particulierDto.password);
